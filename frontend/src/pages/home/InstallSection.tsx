...
export default function InstallSection({
  ...
  return (
    <section className="py-16 border-y border-nova-border bg-nova-surface/40">
      <div className="max-w-300 mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col gap-3 w-full md:w-auto">
            <div className="flex items-center gap-3 p-3.5 bg-nova-bg border border-nova-border rounded-lg">
              ...
              <button
                ...
                className={`min-w-20 flex items-center gap-1 px-2.5 py-1 rounded text-xs font-mono transition-all ${
                  installCopied
