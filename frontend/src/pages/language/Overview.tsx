      ...
      <div className="max-w-275 mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h1 className="mb-6 text-4xl font-bold text-nova-text">Overview</h1>
            ...
            <div className="flex gap-3">
              <Link to="/language/syntax" className="nova-btn-primary text-sm">
                Explore Syntax
                <ArrowRight size={14} />
              </Link>
          ...
          <div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              {OVERVIEW_STATS.map((stat) => (
                <div key={stat.label} className="nova-surface p-4 text-center">
